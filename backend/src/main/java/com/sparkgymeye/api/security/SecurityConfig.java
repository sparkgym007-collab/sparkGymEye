...
public class SecurityConfig {
    ...
    @Bean
    SecurityFilterChain securityFilterChain(HttpSecurity http, CookieSessionAuthFilter cookieSessionAuthFilter) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/members/me", "/api/payments/me").authenticated()
                ...
                .addFilterBefore(cookieSessionAuthFilter, UsernamePasswordAuthenticationFilter.class)
                .build();
    }
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOriginPatterns(List.of(
                "http://localhost:*",
                "https://*.vercel.app",
                "https://sparkgymeye.sparkgym007.workers.dev"
        ));
